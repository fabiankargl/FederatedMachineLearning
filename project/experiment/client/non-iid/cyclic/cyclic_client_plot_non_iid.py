...
def main():
    ...
    create_plot('auc', None, "client_auc_cyclic_non_iid.png", "Average (Cyclic - Non-IID)", auc_order, all_data, script_dir)

    create_plot('f1', None, "client_f1_cyclic_non_iid.png", "Average (Cyclic - Non-IID)", f1_order, all_data, script_dir)
