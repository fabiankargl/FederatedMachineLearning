...
def main():
    ...
    create_plot('auc', None, "client_auc_bagging_non_iid.png", "Average (Bagging - Non-IID)", auc_order, all_data, script_dir)

    create_plot('f1', None, "client_f1_bagging_non_iid.png", "Average (Bagging - Non-IID)", f1_order, all_data, script_dir)
